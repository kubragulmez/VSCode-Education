...
def urunSatistaMi(urunKodu, urunAdi, fiyat, satistaMi):
    if satistaMi:
        print(f"Ürün kodu {urunKodu} olan {urunAdi} isimli ürünün {fiyat} TL fiyat ile satıştadır. ")
    else:
        print(f"Ürün kodu {urunKodu} olan {urunAdi} isimli ürünümüz satışta değildir. ")

urunSatistaMi(satistaMi=True, fiyat=45.78, urunAdi="Filtre Kahve", urunKodu="v60")
"""
# endregion